...
public class BaseballThings {
	...
	public static void main(String[] args) {
		...
		// will look something like: { {atBat1, atBat2}, {atBat1, atBat2, atBat3}, {atBat1} }

		for (int i = 0; i < batterStats.length; ++i) { // iterate through batters
			System.out.printf("For batter %d,", i + 1);
			int numAtBats = Validator.getInt(input, " please enter the number of at-bats: "); // get number of at-bats
			...
			for (int j = 0; j < numAtBats; ++j) { // iterate through at-bats for this batter
				System.out.printf("For bat %d (for batter %d),", j + 1, i + 1);
